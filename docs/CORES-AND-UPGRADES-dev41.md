# Cores and Projector Upgrades — authoritative design contract (dev.41)
...
>
> **Implemented systems are still governed by current source + `CURRENT-IMPLEMENTATION-AUDIT-dev41.md`.** Nothing here becomes implemented merely because it is frozen for future work.
>
> Crying-Obsidian farming/crystal/Beacon-absorption details live in `CRYING-OBSIDIAN-ECOSYSTEM-dev41.md` and override older shard/conversion text.
...
Full shard acquisition/growth contract: `CRYING-OBSIDIAN-ECOSYSTEM-dev41.md`.

---

# 3. Current broad Glass model layers are deprecated

Current dev.40/dev.41 chassis art still contains thin/broad Glass or Glass-Pane surfaces. At the dimensions/UV sampling used by the projectors, vanilla Glass often loses the border that visually communicates thickness and reads instead as an angle-dependent translucent ghost layer.
...
Detailed crystal behavior lives in `CRYING-OBSIDIAN-ECOSYSTEM-dev41.md`.
...
This document is one part of the broader roadmap in `CURRENT-STATE-ROADMAP-dev41.md`.
