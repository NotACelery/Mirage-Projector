# Crying Obsidian Ecosystem — authoritative design contract (dev.41)

> **Status:** authoritative **planned** design for the renewable Crying Obsidian / shard / crystal-growth / Beacon-refraction branch. None of the new blocks/items in this document are implemented in dev.41 unless explicitly stated otherwise.
>
...
Internal/tag naming should use a stable Mirage namespace; historical docs or code comments that mention `Cut Obsidian Shard` must be treated as superseded terminology when this item is implemented.
