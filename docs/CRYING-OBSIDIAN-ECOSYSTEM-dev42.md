# Crying Obsidian Ecosystem — authoritative design contract (dev.42)

> **Status:** authoritative dev.42 contract. The Crying Obsidian Shard item + Stonecutter/re-form recipes are implemented in dev.42 source; renewable Bud/Cluster growth and Beacon crystal behavior remain planned for dev.43 unless explicitly stated otherwise.
>
...
# Improved-Core -> Beacon -> Crystal coupling (future, frozen in dev.42)

This interaction is **defined but not implemented in dev.42**. It must be considered when the Improved-Core Beacon relay and powered Crying-Obsidian crystals are implemented.
