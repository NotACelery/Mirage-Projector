# NEXT CHAT HANDOFF — 0.1.0-dev.79e

## Recovery baseline

Use **`0.1.0-dev.79e`** as the latest recoverable source snapshot.
...
The dev.79e gate additionally verifies:
...
- version `0.1.0-dev.79e`, protocol 26.
