# Cores and Projector Upgrades — authoritative design contract (dev.45)

> **Status:** authoritative mixed contract for dev.45. Core Chamber/material language and the complete chassis-upgrade progression are now implemented source candidates. Improved Cores and their Beacon relay remain planned.
>
