...
- protocol 25/static-light architecture;
- empty Core-slot behavior;
- integer-grid candidate models;
- non-Tall model hash locks;
...
- `Use This Projection` explicitly activates that source and turns projection back on;
