# NEXT CHAT HANDOFF — 0.1.0-dev.79f

## Recovery baseline

Use **`0.1.0-dev.79f`** as the latest recoverable source snapshot.
...
The dev.79f gate additionally verifies:
...
- version `0.1.0-dev.79f`, protocol 26.
