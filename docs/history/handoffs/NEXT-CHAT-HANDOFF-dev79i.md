# NEXT CHAT HANDOFF — 0.1.0-dev.79i

## Recovery baseline

Use **`0.1.0-dev.79i`** as the latest recoverable source snapshot.
...
The dev.79h gate additionally verifies:
...
- version `0.1.0-dev.79h`, protocol 26.
