# NEXT CHAT HANDOFF — 0.1.0-dev.81

Use **`0.1.0-dev.81`** as the latest recoverable source snapshot. Network protocol is **27**.
...
- save/reload + old-world migration smoke test on the new source-ID codec;
...
Then run Windows `build.bat` with Java 21. The static suite verifies the dev.81 source-ID/provider/transform/energy contracts plus the previously accepted projector/light regressions.
