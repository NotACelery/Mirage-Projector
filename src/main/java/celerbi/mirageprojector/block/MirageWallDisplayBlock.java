...
/**
 * Low-profile data-show chassis. It sits on a complete flat block top and projects toward the
 * horizontal FACING direction until it finds a real planar wall. It is deliberately not a
 * wall-mounted hologram emitter.
 */
public final class MirageWallDisplayBlock extends MirageProjectorBlock {
    public static final MapCodec<MirageWallDisplayBlock> CODEC = simpleCodec(MirageWallDisplayBlock::new);

    public MirageWallDisplayBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
