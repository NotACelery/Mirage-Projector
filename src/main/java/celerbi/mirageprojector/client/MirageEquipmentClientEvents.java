...
public final class MirageEquipmentClientEvents {
    ...
    public static void onScreenInit(ScreenEvent.Init.Post event) {
        ...
        int panelX = guiLeft + 180;
        int panelY = guiTop + 3;

        // Compact toggle below the crafting result region; it remains inside the vanilla frame
        // so opening the Mirage panel can never cover its own toggle button.
        int toggleX = guiLeft + 156;
        int toggleY = guiTop + 61;
    ...
    private static final class MinecraftScreenReinitializer {
        ...
        static void reinitialize(InventoryScreen screen) {
            var minecraft = net.minecraft.client.Minecraft.getInstance();
