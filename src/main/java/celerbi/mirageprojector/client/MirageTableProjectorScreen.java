...
/**
 * Table-only settings screen.
 *
 * <p>The widget geometry intentionally mirrors {@link MirageProjectorScreen} 1:1. The class is
 * separate so Table behaviour can evolve without adding chassis conditionals to the canonical
 * upright-projector screen again.</p>
 */
public final class MirageTableProjectorScreen extends ResponsiveContainerScreen<MirageProjectorMenu> {
    ...
    public MirageTableProjectorScreen(MirageProjectorMenu menu, Inventory inventory, Component title) {
