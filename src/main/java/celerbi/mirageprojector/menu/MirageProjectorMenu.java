...
public final class MirageProjectorMenu extends AbstractContainerMenu {
    ...
    public ItemStack projectedItemStack() {
        return projector == null ? ItemStack.EMPTY : projector.projectedStack();
    }
    @Nullable
    ...
    public boolean hasLegacyProjectionReturnItem() {
        return projector != null && projector.hasLegacyProjectionReturnItem();
    }
    ...
    public int projectedSourceCount() {
        return projector == null ? 0 : projector.projectedSourceCount();
    }
    @Nullable
    public HumanoidPosePreset activeHumanoidPose() {
        if (projector == null || projector.settings().sourceMode() != ProjectionSettings.SourceMode.ENTITY) {
            return null;
        }
