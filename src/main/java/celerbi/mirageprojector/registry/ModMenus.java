...
public final class ModMenus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<EntityScannerMenu>> ENTITY_SCANNER =
            MENUS.register("entity_scanner", () -> IMenuTypeExtension.create(EntityScannerMenu::new));
