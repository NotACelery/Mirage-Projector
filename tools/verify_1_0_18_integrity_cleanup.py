...
need(('PROJECTOR_PLAYER_INV_Y = 232' in portable_menu or 'PROJECTOR_PLAYER_INV_Y = 198' in portable_menu or 'PROJECTOR_PLAYER_INV_Y = 190' in portable_menu or 'PROJECTOR_PLAYER_INV_Y = 158' in portable_menu), 'Portable Device player inventory Y does not preserve control/inventory separation')
need(('PROJECTOR_HEIGHT = 326' in portable_screen or 'PROJECTOR_HEIGHT = 294' in portable_screen or 'HEIGHT = 274' in portable_screen or 'PROJECTOR_HEIGHT = 242' in portable_screen), 'Portable Device screen height does not fit the current control/inventory layout')
