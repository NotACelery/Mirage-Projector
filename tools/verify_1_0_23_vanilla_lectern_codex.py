...
props = raw_props.replace('mod_version=1.0.31', 'mod_version=1.0.30')
...
current_minor = 31 if 'mod_version=1.0.31' in raw_props else (30 if 'mod_version=1.0.30' in props else (29 if 'mod_version=1.0.29' in props else (28 if is_1028 else (27 if is_1027 else (26 if is_1026 else (25 if is_1025 else (24 if is_1024 else 23)))))))
