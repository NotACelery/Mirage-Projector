...
expected = {
    'mirage_projector': {'gui': 0.80, 'third': 0.68, 'first': 0.78, 'ground': 0.34, 'fixed': 0.50, 'gui_y': 0.50, 'third_y': 3.5, 'first_y': 1.5},
    'mirage_display': {'gui': 0.74, 'third': 0.62, 'first': 0.72, 'ground': 0.30, 'fixed': 0.46, 'gui_y': 0.00, 'third_y': 3.5, 'first_y': 1.5},
    'mirage_field_projector': {'gui': 0.70, 'third': 0.60, 'first': 0.70, 'ground': 0.28, 'fixed': 0.44, 'gui_y': 0.00, 'third_y': 3.5, 'first_y': 1.5},
    'wide_mirage_projector': {'gui': 0.74, 'third': 0.62, 'first': 0.72, 'ground': 0.30, 'fixed': 0.46, 'gui_y': 0.00, 'third_y': 3.5, 'first_y': 1.5},
    'tall_mirage_projector': {'gui': 0.68, 'third': 0.60, 'first': 0.70, 'ground': 0.28, 'fixed': 0.44, 'gui_y': 0.00, 'third_y': 3.5, 'first_y': 1.5},
    'mirage_prism': {'gui': 0.76, 'third': 0.64, 'first': 0.74, 'ground': 0.31, 'fixed': 0.48, 'gui_y': 0.25, 'third_y': 3.5, 'first_y': 1.5},
}
...
if errors:
    print('dev.80b projector hand-visibility verification FAILED')
    for e in errors:
        print(' -', e)
    raise SystemExit(1)
print('dev.80b projector hand-visibility verification PASS')
