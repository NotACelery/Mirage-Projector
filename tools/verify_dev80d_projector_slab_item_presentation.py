...
expected = {
    'mirage_projector': {'gui': 0.72, 'third': 0.42, 'first': 0.48, 'ground': 0.30, 'fixed': 0.44, 'gui_y': 0.0, 'third_y': 1.6, 'first_y': 0.15},
    'mirage_display': {'gui': 0.68, 'third': 0.40, 'first': 0.46, 'ground': 0.28, 'fixed': 0.42, 'gui_y': -0.1, 'third_y': 1.6, 'first_y': 0.15},
    'mirage_field_projector': {'gui': 0.66, 'third': 0.38, 'first': 0.44, 'ground': 0.27, 'fixed': 0.40, 'gui_y': -0.1, 'third_y': 1.6, 'first_y': 0.15},
    'wide_mirage_projector': {'gui': 0.68, 'third': 0.40, 'first': 0.46, 'ground': 0.28, 'fixed': 0.42, 'gui_y': -0.1, 'third_y': 1.6, 'first_y': 0.15},
    'tall_mirage_projector': {'gui': 0.64, 'third': 0.38, 'first': 0.44, 'ground': 0.27, 'fixed': 0.40, 'gui_y': -0.15, 'third_y': 1.6, 'first_y': 0.15},
    'mirage_prism': {'gui': 0.70, 'third': 0.41, 'first': 0.47, 'ground': 0.29, 'fixed': 0.43, 'gui_y': 0.0, 'third_y': 1.6, 'first_y': 0.15},
}
...
if errors:
    print('dev.80d projector slab-like item presentation verification FAILED')
    for e in errors:
        print(' -', e)
    raise SystemExit(1)
print('dev.80d projector slab-like item presentation verification PASS')
