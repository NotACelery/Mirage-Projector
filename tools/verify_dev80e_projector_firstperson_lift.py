...
expected = {
    'mirage_projector': {'gui': 0.72, 'third': 0.42, 'first': 0.48, 'ground': 0.30, 'fixed': 0.44, 'gui_y': 0.0, 'third_y': 1.6, 'first_y': 1.05},
...
if errors:
    print('dev.80e projector first-person lift verification FAILED')
    for e in errors:
        print(' -', e)
    raise SystemExit(1)
print('dev.80e projector first-person lift verification PASS')
