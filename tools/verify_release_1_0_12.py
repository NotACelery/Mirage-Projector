...
need(any(f'mod_version=1.0.{minor}' in props for minor in (12, 13, 14, 15, 16, 17, 18, 19, 20)), 'gradle.properties is not a compatible 1.0.12+ line')
...
need(('NETWORK_PROTOCOL = "29"' in main or 'NETWORK_PROTOCOL = "30"' in main or 'NETWORK_PROTOCOL = "31"' in main or 'NETWORK_PROTOCOL = "32"' in main or 'NETWORK_PROTOCOL = "33"' in main or 'NETWORK_PROTOCOL = "34"' in main), 'network protocol is not a compatible 1.0.12+ value')
