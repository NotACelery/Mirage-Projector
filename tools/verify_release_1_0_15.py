...
need(('mod_version=1.0.15' in props or 'mod_version=1.0.16' in props or 'mod_version=1.0.17' in props or 'mod_version=1.0.18' in props), 'gradle.properties is not a compatible 1.0.15+ line')
