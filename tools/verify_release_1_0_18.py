...
need((RES / 'assets/mirage_projector/textures/item/mirage_lantern.png').exists(), 'Mirage Lantern 16x16 texture missing')
need((MODELS / 'item/mirage_hand_projector.json').exists(), 'Mirage Hand Projector item model missing')
need((RES / 'assets/mirage_projector/textures/item/mirage_hand_projector.png').exists(), 'Mirage Hand Projector 16x16 texture missing')
need('creative_battery' in item_ids, 'Creative Battery item registry ID missing')
need('arm_strap' in item_ids, 'Arm Strap item registry ID missing')
need((MODELS / 'item/creative_battery.json').exists(), 'Creative Battery item model missing')
need((RES / 'assets/mirage_projector/textures/item/creative_battery.png').exists(), 'Creative Battery 16x16 texture missing')
need((MODELS / 'item/arm_strap.json').exists(), 'Arm Strap item model missing')
need((RES / 'assets/mirage_projector/textures/item/arm_strap.png').exists(), 'Arm Strap 16x16 texture missing')
...
need((SRC / 'celerbi/mirageprojector/item/MirageHandProjectorItem.java').exists(), 'MirageHandProjectorItem missing')
need((SRC / 'celerbi/mirageprojector/client/ClientHeldProjectors.java').exists(), 'ClientHeldProjectors missing')
...
need((MODELS / 'item/battery_pouch_expansion_patch.json').exists(), 'Battery Pouch Expansion Patch model missing')
need((RES / 'assets/mirage_projector/textures/item/auto_battery_swap_patch.png').exists(), 'Auto Battery Swap Patch texture missing')
...
need(('Mirage Projector 1.0.18' in current_impl or 'Mirage Projector 1.0.19' in current_impl or 'Mirage Projector 1.0.20' in current_impl or 'Mirage Projector 1.0.21' in current_impl or 'Mirage Projector 1.0.22' in current_impl or 'Mirage Projector 1.0.23' in current_impl or 'Mirage Projector 1.0.24' in current_impl or ('Mirage Projector 1.0.25' in current_impl or 'Mirage Projector 1.0.26' in current_impl or 'Mirage Projector 1.0.27' in current_impl or 'Mirage Projector 1.0.28' in current_impl or 'Mirage Projector 1.0.29' in current_impl or 'Mirage Projector 1.0.30' in current_impl or 'Mirage Projector 1.0.31' in current_impl or 'Mirage Projector 1.0.32' in current_impl or 'Mirage Projector 1.0.33', 'Mirage Projector 1.0.34' in current_impl or 'Mirage Projector 1.0.34' in current_impl)) and ('Network protocol: **34**' in current_impl or 'Network protocol: **35**' in current_impl or 'Network protocol: **36**' in current_impl or ('Network protocol: **37**' in current_impl or 'Network protocol: **38**' in current_impl or 'Network protocol: **39**' in current_impl or 'Network protocol: **40**' in current_impl or 'Network protocol: **41**' in current_impl or 'Network protocol: **42**' in current_impl or 'Network protocol: **43**' in current_impl)),
     'current implementation authority is not on a compatible protocol-34 line')
need(('Current implementation snapshot: **1.0.18**' in roadmap or 'Current implementation snapshot: **1.0.19**' in roadmap or 'Current implementation snapshot: **1.0.20**' in roadmap or 'Current implementation snapshot: **1.0.21**' in roadmap or 'Current implementation snapshot: **1.0.22**' in roadmap or 'Current implementation snapshot: **1.0.23**' in roadmap or 'Current implementation snapshot: **1.0.24**' in roadmap or 'Current implementation snapshot: **1.0.25**' in roadmap or 'Current implementation snapshot: **1.0.26**' in roadmap or 'Current implementation snapshot: **1.0.27**' in roadmap or 'Current implementation snapshot: **1.0.28**' in roadmap or 'Current implementation snapshot: **1.0.29**' in roadmap or 'Current implementation snapshot: **1.0.30**' in roadmap or 'Current implementation snapshot: **1.0.31**' in roadmap or 'Current implementation snapshot: **1.0.32**' in roadmap or 'Current implementation snapshot: **1.0.33**', 'Current implementation snapshot: **1.0.34**' in roadmap or 'Current implementation snapshot: **1.0.34**' in roadmap), 'roadmap current snapshot is not a compatible 1.0.18+ line')
need(('Current maintenance baseline: **1.0.18**' in development or 'Current maintenance baseline: **1.0.19**' in development or 'Current maintenance baseline: **1.0.20**' in development or 'Current maintenance baseline: **1.0.21**' in development or 'Current maintenance baseline: **1.0.22**' in development or 'Current maintenance baseline: **1.0.23**' in development or 'Current maintenance baseline: **1.0.24**' in development or ('Current maintenance baseline: **1.0.25**' in development or 'Current maintenance baseline: **1.0.26**' in development or 'Current maintenance baseline: **1.0.27**' in development or 'Current maintenance baseline: **1.0.28**' in development or 'Current maintenance baseline: **1.0.29**' in development or 'Current maintenance baseline: **1.0.30**' in development or 'Current maintenance baseline: **1.0.31**' in development or 'Current maintenance baseline: **1.0.32**' in development or 'Current maintenance baseline: **1.0.33**', 'Current maintenance baseline: **1.0.34**' in development or 'Current maintenance baseline: **1.0.34**' in development)) and ('Network protocol: **34**' in development or 'Network protocol: **35**' in development or 'Network protocol: **36**' in development or ('Network protocol: **37**' in development or 'Network protocol: **38**' in development or 'Network protocol: **39**' in development or 'Network protocol: **40**' in development or 'Network protocol: **41**' in development or 'Network protocol: **42**' in development or 'Network protocol: **43**' in development)),
     'development guide baseline is not a compatible protocol-34 line')
need(('Documentation Authority — Mirage Projector 1.0.18' in authority or 'Documentation Authority — Mirage Projector 1.0.19' in authority or 'Documentation Authority — Mirage Projector 1.0.20' in authority or 'Documentation Authority — Mirage Projector 1.0.21' in authority or 'Documentation Authority — Mirage Projector 1.0.22' in authority or 'Documentation Authority — Mirage Projector 1.0.23' in authority or 'Documentation Authority — Mirage Projector 1.0.24' in authority or 'Documentation Authority — Mirage Projector 1.0.25' in authority or 'Documentation Authority — Mirage Projector 1.0.26' in authority or 'Documentation Authority — Mirage Projector 1.0.27' in authority or 'Documentation Authority — Mirage Projector 1.0.28' in authority or 'Documentation Authority — Mirage Projector 1.0.29' in authority or 'Documentation Authority — Mirage Projector 1.0.30' in authority or 'Documentation Authority — Mirage Projector 1.0.31' in authority or 'Documentation Authority — Mirage Projector 1.0.32' in authority or 'Documentation Authority — Mirage Projector 1.0.33', 'Documentation Authority — Mirage Projector 1.0.34' in authority or 'Documentation Authority — Mirage Projector 1.0.34' in authority),
...
need('CYCLE_FLASHLIGHT_MODE' in portable_screen and ('toggle_projection' in portable_screen or ('turn_on' in portable_screen and 'turn_off' in portable_screen)),
...
if errors:
    print('Mirage Projector 1.0.18 release audit FAILED')
    for error in errors:
        print(' -', error)
    raise SystemExit(1)

print(f'Mirage Projector 1.0.18 release audit PASS ({len(json_files)} JSON, {len(block_ids)} blocks, {len(item_ids)} items, {len(langs.get("en_us", {}))} lang keys)')
for note in notes:
    print('NOTE', note)
