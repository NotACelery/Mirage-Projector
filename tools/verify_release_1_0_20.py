...
need(any(v in read('docs/ROADMAP.md') for v in ('Current implementation snapshot: **1.0.20**', 'Current implementation snapshot: **1.0.21**', 'Current implementation snapshot: **1.0.22**', 'Current implementation snapshot: **1.0.23**', 'Current implementation snapshot: **1.0.24**', 'Current implementation snapshot: **1.0.25**', 'Current implementation snapshot: **1.0.26**', 'Current implementation snapshot: **1.0.27**', 'Current implementation snapshot: **1.0.28**', 'Current implementation snapshot: **1.0.29**', 'Current implementation snapshot: **1.0.30**', 'Current implementation snapshot: **1.0.31**', 'Current implementation snapshot: **1.0.32**')), 'roadmap baseline is not a compatible 1.0.20+ line')
need(any(v in read('docs/DEVELOPMENT.md') for v in ('Current maintenance baseline: **1.0.20**', 'Current maintenance baseline: **1.0.21**', 'Current maintenance baseline: **1.0.22**', 'Current maintenance baseline: **1.0.23**', 'Current maintenance baseline: **1.0.24**', 'Current maintenance baseline: **1.0.25**', 'Current maintenance baseline: **1.0.26**', 'Current maintenance baseline: **1.0.27**', 'Current maintenance baseline: **1.0.28**', 'Current maintenance baseline: **1.0.29**', 'Current maintenance baseline: **1.0.30**', 'Current maintenance baseline: **1.0.31**', 'Current maintenance baseline: **1.0.32**')), 'development baseline is not a compatible 1.0.20+ line')
need(any(v in read('docs/DOCUMENTATION-AUTHORITY.md') for v in ('Documentation Authority — Mirage Projector 1.0.20', 'Documentation Authority — Mirage Projector 1.0.21', 'Documentation Authority — Mirage Projector 1.0.22', 'Documentation Authority — Mirage Projector 1.0.23', 'Documentation Authority — Mirage Projector 1.0.24', 'Documentation Authority — Mirage Projector 1.0.25', 'Documentation Authority — Mirage Projector 1.0.26', 'Documentation Authority — Mirage Projector 1.0.27', 'Documentation Authority — Mirage Projector 1.0.28', 'Documentation Authority — Mirage Projector 1.0.29', 'Documentation Authority — Mirage Projector 1.0.30', 'Documentation Authority — Mirage Projector 1.0.31', 'Documentation Authority — Mirage Projector 1.0.32')), 'documentation authority is not a compatible 1.0.20+ line')
