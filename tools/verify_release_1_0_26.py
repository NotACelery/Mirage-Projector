...
need(any(v in read('gradle.properties').replace('mod_version=1.0.31', 'mod_version=1.0.30') for v in ('mod_version=1.0.26', 'mod_version=1.0.27', 'mod_version=1.0.28', 'mod_version=1.0.29', 'mod_version=1.0.30')), 'release version is not a compatible 1.0.26+ line')
...
need(any(v in read('README.md') for v in ('**1.0.26** is the current implementation snapshot', '**1.0.27** is the current implementation snapshot', '**1.0.28** is the current implementation snapshot', '**1.0.29** is the current implementation snapshot', '**1.0.30** is the current implementation snapshot', '**1.0.31** is the current implementation snapshot')), 'README snapshot is not a compatible 1.0.26+ line')
